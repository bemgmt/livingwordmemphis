  ...
  return (
    <>
      {isHome && (
        <div
          className={cn(
            "fixed left-0 right-0 top-0 z-[1000] flex flex-col gap-2 px-4 py-2 text-xs font-medium tracking-wide text-white/95 backdrop-blur-md transition-all duration-300 lg:flex-row lg:items-center lg:justify-between lg:text-sm",
      ...
      >
        <nav
          className={cn(
            "flex w-full items-center justify-between gap-3 px-4 py-3 transition-colors duration-300 sm:px-5",
            isHome && "absolute left-0 right-0 top-0",
            isHome &&
              (scrolled
                ? "border-b border-border/80 bg-background/90 text-foreground shadow-sm backdrop-blur-xl"
          ...
          <ul className="hidden items-center gap-0.5 lg:flex">
            ...
            <li>
              <Link
                href="/auth/login"
                className={cn(
                  "ml-1 inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-sm font-medium transition-colors",
                  isHome && !scrolled
