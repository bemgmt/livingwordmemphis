...
test("PDF preserves Unicode, multiple pages, signature and frozen schema; rejects unsupported glyphs before signing", async () => {
  ...
  const long = { ...submission, answers: { ...answers, notes: "Long care notes with wrapping. ".repeat(65), temperament: "x".repeat(2000), feedingInstructions: "Special feeding instructions. ".repeat(65), foodsToAvoid: "Foods to avoid. ".repeat(120), allergyDetails: "Allergy emergency instructions. ".repeat(60) } };
